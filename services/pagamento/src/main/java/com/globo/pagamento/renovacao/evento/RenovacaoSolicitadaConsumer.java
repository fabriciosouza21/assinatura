package com.globo.pagamento.renovacao.evento;

import com.globo.pagamento.renovacao.CriarPagamentoRenovacao;
 ...
 * de renovacao ao {@link CriarPagamentoRenovacao}. Eventos invalidos disparam {@link
...
public class RenovacaoSolicitadaConsumer {
  ...
  private final CriarPagamentoRenovacao criarPagamentoRenovacaoService;
  ...
  public RenovacaoSolicitadaConsumer(
      ObjectMapper objectMapper, CriarPagamentoRenovacao criarPagamentoRenovacaoService) {
