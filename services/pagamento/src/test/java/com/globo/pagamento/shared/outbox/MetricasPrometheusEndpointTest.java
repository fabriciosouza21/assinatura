 ...
 *
 * <p>Sobe o contexto Spring inteiro (datasource e Flyway contra o Postgres do docker-compose na
 * porta 5433, listeners do Kafka desligados) e dispara requisicao HTTP real sem credenciais, via
