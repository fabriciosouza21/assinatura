 ...
 * {@code com.globo.assinatura.shared.seguranca}) seja carregado no slice. Porem, a autoconfiguracao
 * padrao de seguranca servlet do Spring Boot ({@link ServletWebSecurityAutoConfiguration}) ainda
 * instala uma cadeia de filtros default com protecao CSRF, que rejeita o POST com 403. Excluir
 * apenas essa autoconfiguracao remove a cadeia default e deixa a requisicao chegar ao controller. A
...
class UsuarioControllerTest {
  ...
  @MockitoBean private CadastrarUsuario usuarioService;
