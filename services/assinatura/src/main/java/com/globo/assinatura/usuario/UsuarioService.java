 ...
 * de dominio e o {@link User} autenticavel ligado, devolvendo o uuid publico atribuido pela
 * entidade.
 */
@Service
public class UsuarioService {
   ...
   *
   * <p>Cria, na mesma transacao, o {@link Usuario} de dominio e o {@link User} autenticavel com
   * {@code username = email}, senha hasheada com BCrypt, {@code role = ROLE_CLIENT} e linkado ao
   * {@link Usuario} via {@code usuario_id}.
   *
