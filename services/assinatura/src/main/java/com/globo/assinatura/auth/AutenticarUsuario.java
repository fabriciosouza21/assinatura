...
public class AutenticarUsuario {
  ...
  public LoginResponse login(LoginRequest request) {
    Credencial user = userRepository.findByUsername(request.username()).orElse(null);
  ...
  private String hashDe(Credencial user) {
    return user != null ? user.getPassword() : SENHA_FANTASMA;
  }

  private String usuarioUuid(Credencial user) {
