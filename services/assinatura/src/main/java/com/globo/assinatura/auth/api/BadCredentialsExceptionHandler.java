 ...
 *
 * <p>Converte {@link BadCredentialsException}, lancada pelo {@link AutenticarUsuario} quando o
 * usuario nao existe ou a senha nao confere, em uma resposta HTTP {@code 401 Unauthorized}. O corpo
 * da resposta e mantido vazio para nao revelar qual das duas condicoes ocorreu, evitando enumeracao
 * de usuarios.
 */
